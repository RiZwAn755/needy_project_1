    ...
    return (
        <div className="fixed right-0 top-1/2 transform -translate-y-1/2 z-50 flex flex-col space-y-4 pr-1">
            ...
            <a
                ...
                aria-label="Call Now"
            >
                <div className="absolute right-full mr-2 px-3 py-1 bg-blue-600 text-white text-xs rounded-md opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap shadow-lg">
                    Call Now
                </div>
            ...
            <a
                ...
                aria-label="WhatsApp"
            >
                <div className="absolute right-full mr-2 px-3 py-1 bg-green-500 text-white text-xs rounded-md opacity-0 group-hover:opacity-100 transition-opacity duration-300 whitespace-nowrap shadow-lg">
                    Chat on WhatsApp
                </div>
