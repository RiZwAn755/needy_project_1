            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div>
                        ...
                        <div className="flex space-x-4">
                            <a href="#" className="text-gray-400 hover:text-green-500 transition-colors bg-gray-900 p-2 rounded-full">
                    ...
                    <div>
                        <h3 className="text-lg font-bold mb-6 text-white border-b-2 border-green-600 pb-2 inline-block">Our Treatments</h3>
                        <ul className="space-y-4">
                            {['Allergy Treatment', 'Migraine & Headache', 'Thyroid Care', 'Skin Care Treatment'].map((item) => (
                                <li key={item}>
                                    <a href="#treatments" className="text-gray-400 hover:text-green-400 transition-colors text-sm flex items-center">
                    ...
                    <div>
                        <h3 className="text-lg font-bold mb-6 text-white border-b-2 border-green-600 pb-2 inline-block">Useful Links</h3>
                        <ul className="space-y-4">
                            {[
                                ...
                                <li key={item.name}>
                                    <a href={item.link} className="text-gray-400 hover:text-green-400 transition-colors text-sm flex items-center">
                                        <ArrowRight className="h-3 w-3 mr-2 text-green-600" />
                                        {item.name}
                                    </a>
                                </li>
                    ...
                    {/* Column 4: Contact Us */}
                    <div>
                        <h3 className="text-lg font-bold mb-6 text-white border-b-2 border-green-600 pb-2 inline-block">Contact Us</h3>
                ...
                <div className="mt-16 border-t border-gray-800 pt-8 text-center">
                    ...
                    <div className="w-full overflow-hidden bg-gray-900 py-2 border-t border-gray-800 rounded-lg">
                        <div className="animate-marquee text-sm text-green-400 font-medium tracking-wider">
